...
public class Exercise2Test {
    ...
    public void getDefaultValue() {
        ...
        Integer joeVal = map.getOrDefault("Joe", 30);

        assertThat(defaultVal, is(30));
        assertThat(joeVal, is(22));
    }
    ...
    public void putIfNotExisting() {
        ...
        /**
         * Try to put 2 entry with key as "Alice" value as 32, key as "Joe" and value as 22 using {@link Map#putIfAbsent}.
         */
    ...
    public void mergeValues() {
        ...
        /**
         * Merge 2 entry to {@link map} with key="Alice" value=32, key="Joe" value=22 using {@link Map#merge}.
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<String, Integer, Integer> remappingFunction = (x, y) -> ++y;
